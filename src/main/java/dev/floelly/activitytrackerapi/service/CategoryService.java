...
public class CategoryService {
    ...
    public CategoryResponse updateCategory(String categoryId, UpdateCategoryRequest categoryRequest) {
        ...
        Category category = categoryRepository.findByBusinessIdAndDeletedAtIsNull(categoryId)
    ...
    public SubCategoryResponse registerNewSubCategory(CreateSubCategoryRequest subCategoryRequest, String categoryBusinessId) {
        ...
        subCategory.setCategory(categoryRepository.findByBusinessIdAndDeletedAtIsNull(categoryBusinessId)
                .orElseThrow(() -> new NotFoundException("Category not found " + categoryBusinessId)));
